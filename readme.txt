...
│   ├── deep_learning_a-z
│   │   ├── additional_readings
│   │   │   └── additional reading links deep_learning_a-z.pdf
...
│   │   │           ├── ml-100k
│   │   │           └── ml-1m
│   │   ├── P16-Convolutional-Neural-Networks
...
│   ├── Learning
│   ├── Machine
│   ├── Machine_Learning_Applications_Using_Python_Case_Studies
│   │   ├── MLApplications_Codebase
...
│   │   ├── P14-Classification-Template
│   │   │   ├── Classification_Template
│   │   │   │   └── classification_template.py
│   │   │   └── __MACOSX
│   │   │       └── Classification_Template
│   │   ├── P14-Clustering-Pros-Cons.pdf
│   │   ├── P14-Convolutional-Neural-Networks
│   │   │   ├── Convolutional_Neural_Networks
│   │   │   │   ├── cnn.py
│   │   │   │   └── dataset
│   │   │   │       ├── test_set
...
│   │   ├── P14-Regression-Template
│   │   │   ├── __MACOSX
│   │   │   │   └── Regression_Template
│   │   │   └── Regression_Template
│   │   │       └── regression_template.py
│   │   ├── P14-Regularization.pdf
...
│   │       │   └── Simple_Autoencoder_Solution.ipynb
│   │       ├── batch-norm
│   │       │   ├── Batch_Normalization_Exercises.ipynb
│   │       │   ├── Batch_Normalization_Lesson.ipynb
│   │       │   └── Batch_Normalization_Solutions.ipynb
│   │       ├── dcgan-svhn
│   │       │   ├── 1511.06434.pdf
│   │       │   ├── assets
│   │       │   ├── checkpoints
...
│   │       │   ├── assets
│   │       │   ├── requirements.txt
│   │       │   ├── Skip-Grams-Solution.ipynb
│   │       │   ├── Skip-Gram_word2vec.ipynb
│   │       │   └── utils.py
│   │       ├── environments
...
│   │       │   ├── requirements.txt
│   │       │   ├── reviews.txt
│   │       │   ├── TFLearn_Digit_Recognition.ipynb
│   │       │   ├── TFLearn_Digit_Recognition_Solution.ipynb
│   │       │   ├── TFLearn_Sentiment_Analysis.ipynb
│   │       │   └── TFLearn_Sentiment_Analysis_Solution.ipynb
...
│   │       ├── semi-supervised
│   │       │   ├── semi-supervised_learning_2.ipynb
│   │       │   └── semi-supervised_learning_2_solution.ipynb
│   │       ├── sentiment-network
│   │       │   ├── labels.txt
│   │       │   ├── requirements.txt
│   │       │   ├── reviews.txt
...
│   │       │   ├── Anna_KaRNNa.ipynb
│   │       │   ├── Anna_KaRNNa_Name_Scoped.ipynb
│   │       │   ├── Anna_KaRNNa_Summaries.ipynb
│   │       │   ├── anna.txt
│   │       │   ├── assets
│   │       │   │   └── charseq.jpeg
│   │       │   ├── requirements.txt
